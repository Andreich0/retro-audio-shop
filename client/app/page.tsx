        ...
        <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 -mt-24 relative z-40">
                ...
                <div className="bg-[#18181b] border border-[#333] hover:border-[#ff6b00] p-10 rounded-xl text-center shadow-2xl transition duration-300 group">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">Всяко устройство минава през пълна профилактика и тест.</p>
                </div>
                ...
                <div className="bg-[#18181b] border border-[#333] hover:border-[#ff6b00] p-10 rounded-xl text-center shadow-2xl transition duration-300 group">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">Уникални модели от 80-те и 90-те години.</p>
                </div>
                ...
                <div className="bg-[#18181b] border border-[#333] hover:border-[#ff6b00] p-10 rounded-xl text-center shadow-2xl transition duration-300 group">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">Сигурна доставка с преглед и тест.</p>
                </div>
            </div>
        </div>
      </section>
