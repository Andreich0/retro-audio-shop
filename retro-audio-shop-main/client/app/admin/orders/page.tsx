...
export default function AdminOrders() {
  ...
  const updateStatus = async (id: number, newStatus: string) => {
    try {
        ...
        if (res.ok) {
            // Обновяваме локалния стейт веднага, за да се види промяната
  ...
  // Функция за зареждане на продуктите в поръчката
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "shipped": return "border-purple-500 text-purple-500";
